...
: ${AMENT_CURRENT_PREFIX:="/workspace/farm_car_system/install/obs_filiter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/obs_filiter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/obs_filiter/environment/path.sh"
